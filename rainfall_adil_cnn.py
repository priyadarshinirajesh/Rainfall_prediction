...
def load_and_prepare_data():
    try:
        # Load individual year datasets with explicit year tagging
         df_2019 = pd.read_csv('/kaggle/input/priyadarshini/adilabad_2019.csv').assign(YEAR=2019)
         df_2020 = pd.read_csv('/kaggle/input/priyadarshini/adilabad_2020.csv').assign(YEAR=2020)
         df_2021 = pd.read_csv('/kaggle/input/priyadarshini/adilabad_2021.csv').assign(YEAR=2021)
         df_2022 = pd.read_csv('/kaggle/input/priyadarshini/adilabad_2022.csv').assign(YEAR=2022)
